...
// 3D path: the 2D scene is drawn on a slab through the middle of the volume
// along z. Brightest at z=0.5, fades smoothly to 0 toward front and back.
export function render3D(index, x, y, z) {
  ...
  h = floor(v) / 1000;
  v = v % 1;
  zFade = 1 - smoothstep(0.15, 0.5, abs(z - 0.5));
  hsv(h, 1, v * zFade);
}